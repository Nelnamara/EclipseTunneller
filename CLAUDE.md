...
- Eclipse detection uses the self-buff **aura** IDs `48517` (Solar) / `48518` (Lunar) via `C_UnitAuras.GetPlayerAuraBySpellID` (was 164547/164812 — 164547 gone, 164812 is Moonfire).
